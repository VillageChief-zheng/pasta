package com.stateunion.p2p.research.retrofit.callback;

import android.app.Dialog;
import android.util.Log;

import com.stateunion.p2p.research.application.ProjectApplication;
import com.stateunion.p2p.research.commons.engine.AppSessionEngine;
import com.stateunion.p2p.research.retrofit.RequestCommand;
import com.stateunion.p2p.research.retrofit.bean.IBaseBean;
import com.stateunion.p2p.research.retrofit.view.IBaseDialogView;
import com.stateunion.p2p.research.util.SysDiaLog;
...
//        AppSessionEngine.logout();
    ...
    public void onFailure(final Call<E> call) {
        Log.e(getAttachTarget().getBaseActivity()+"cesj","ss");
